    ...
    function callBurnedSupply() {
      $.ajax({
        ...
        success: function (result) {
          ...
          burnedSupply = result.balances[505].balance / 100;
          // callback
          useBurnedSupply();
        },
      });
        ...
        $.each(txs, function (i, data) {
          ...
          $("#transactionList").append(
            ...
            <a data-alias="` +
              ...
              `" class="list-group-item list-group-item-action" data-toggle="modal" data-target="#searchModal">
              <div class="d-flex w-100 justify-content-between">
                <h5 class="mb-1">` +
              thousands_separators(data.amount / 100) +
              ` eIDR</h5>
                <small class="timeago">` +
              waktu +
              `</small>
      ...
      $(".modal-body").html(
        `
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item">Saldo eIDR: <strong>` +
          thousands_separators(eIDRbalance) +
          `</strong></li>
            <li class="list-group-item">Saldo LMB: <strong>` +
          thousands_separators(LMBbalance) +
          `</strong></li>
            <li class="list-group-item">Total Transaksi: ` +
          transactionCounts +
          ` kali</li>
            <li class="list-group-item">Dibuat sejak: <small>` +
          dateCreated +
          `</small></li>
          </ul>
        `
    ...
    success: function (result) {
      ...
      $(".modal-body").html(
        `
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item">Pengirim: <strong>` +
          result.ownerAddress +
          `</strong></li>
            <li class="list-group-item">Penerima: <strong>` +
          result.toAddress +
          `</strong></li>
            <li class="list-group-item">Nominal Transfer: <strong>` +
          thousands_separators(nominal) +
          token +
          `</strong> </li>
            <li class="list-group-item">Waktu Transaksi: ` +
          waktu +
          ` </li>
            <li class="list-group-item">Status Konfirmasi: ` +
          result.confirmed +
          `</li>
            <li class="list-group-item">Keterangan: ` +
          result.data +
          `</li>
            <li class="list-group-item text-break">Hash: ` +
          hash +
          `</li>
          </ul>
        `
